...
export class CategoryService {
  ...
  createOrEditAndAttachToStore(storeId: number, category: Category): Observable<Category> {
    return this.http.put<Category>(environment.apiURL + 'store/' + storeId + '/category', category);
  }
